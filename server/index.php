    ...
    <div class="card">
        ...
        <div class="body">
            ...
            <div class="steps">
                ...
                <div class="step"><div class="n">5</div><p><b>Откройте раздел «Анализ».</b> После загрузки данных стенд автоматически рассчитает объёмы и стоимость по периодам, рейтинг стран, динамику цен и изменения рынка. В блоке <b>«Сигналы и риски»</b> можно посмотреть концентрацию рынка, зависимость от главного поставщика, изменение состава участников и разброс цен. Ниже появится блок <b>«Что делать»</b> с рекомендациями, рассчитанными по тем же показателям.</p></div>
                ...
                <div class="step"><div class="n">7</div><p><b>Соберите презентацию.</b> В разделе <b>«Презентации»</b> можно подготовить слайды на основании показателей, рассчитанных по загруженным открытым данным UN Comtrade и World Bank WITS.</p></div>
            </div>
