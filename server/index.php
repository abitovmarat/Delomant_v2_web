    ...
    <div class="card">
        ...
        <div class="body">
            ...
            <div class="steps">
                ...
                <div class="step"><div class="n">7</div><p><b>Соберите презентацию.</b> В разделе <b>«Презентации»</b> можно подготовить слайды на основании показателей, рассчитанных по загруженным открытым данным UN Comtrade и World Bank WITS. Кнопка <b>«Собрать всё, что есть»</b> сделает отчёт целиком: стенд сам возьмёт те разделы, которые ваша выгрузка поддерживает, и добавит слайд о полноте данных и источниках.</p></div>
            </div>
