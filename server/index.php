    ...
    <div class="card">
        ...
        <div class="body">
            <div class="lead">
                ...
                Он работает на открытых источниках: UN Comtrade, World Bank WITS и зарубежная
                таможенная статистика. Стенд сделан для проверки функциональности при экспертизе,
                поэтому доступны здесь не все возможности программы.
            </div>
            ...
            <div class="steps">
                ...
                <div class="step"><div class="n">2</div><p><b>Найдите товар, если не знаете код.</b> Откройте <b>«Данные»</b>, карточку <b>«UN Comtrade»</b>. Там есть справочник кодов. Впишите название товара, например «клубника» или «сыр», и стенд покажет подходящие коды ТН ВЭД. Нажмите на нужный, и он встанет в поле слева. Кодов можно набрать сразу несколько.</p></div>

                <div class="step"><div class="n">3</div><p><b>Выберите условия.</b> Импорт или экспорт, с кем идёт торговля: с конкретной страной или со всем миром. Дальше отметьте страны. Их можно выбирать по одной, а можно взять сразу регион, например «Европу» или «ЕАЭС». Осталось указать период и нажать <b>«Загрузить данные»</b>.</p></div>
                ...
                <div class="step"><div class="n">4</div><div><p><b>Заберите результат.</b> Есть четыре варианта:</p>
                    ...
                    <b>Показать тарифы</b>. Ставка ввозной пошлины по выбранному коду. Видно, сколько рынок покупает и во сколько обойдётся вход на него.</p></div></div>

                <div class="step"><div class="n">5</div><p><b>Загляните в «Анализ», там всё уже посчитано.</b> Объёмы и стоимость по периодам, рейтинг стран, динамика цен, изменения рынка. Отдельно стоит открыть <b>«Сигналы и риски»</b>. Стенд покажет концентрацию рынка, зависимость от главного поставщика, кто на рынок пришёл и кто ушёл, разброс цен. Ниже будет блок <b>«Что делать»</b> с рекомендациями, которые выведены из этих же цифр.</p></div>

                <div class="step"><div class="n">6</div><p><b>«Обогащение» дополнит выгрузку.</b> Оно расшифрует коды ТН ВЭД в названия товаров, подставит регион мира по стране, посчитает цену за килограмм и ставку пошлины.</p></div>

                <div class="step"><div class="n">7</div><p><b>Что ещё посмотреть.</b> В разделе <b>«Зарубежная таможня»</b> лежит готовая статистика Казахстана, Кыргызстана и Колумбии, загружать туда ничего не нужно. В <b>«Презентации»</b> собираются слайды из посчитанных показателей.</p></div>
            </div>
