    ...
    <div class="card">
        ...
        <div class="body">
            ...
            <div class="steps">
                ...
                <div class="step"><div class="n">7</div><p><b>Соберите презентацию.</b> В разделе <b>«Презентации»</b> можно подготовить слайды на основании показателей, рассчитанных по загруженным открытым данным UN Comtrade и World Bank WITS. Кнопка <b>«Собрать всё, что есть»</b> сделает отчёт целиком: стенд сам возьмёт те разделы, которые ваша выгрузка поддерживает. А если отчёт хочется собрать по-своему, рядом есть кнопка <b>«Все данные в Excel»</b>: она выгружает одним файлом всё посчитанное — объёмы, страны, цены, изменения рынка, сигналы и рекомендации, каждый расчёт на своём листе. Дальше можно брать нужные цифры и собирать материал под свою задачу.</p></div>
            </div>
        </div>
