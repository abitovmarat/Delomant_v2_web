    ...
    <div class="card">
        ...
        <div class="body">
            ...
            <div class="steps">
                ...
                <div class="step"><div class="n">2</div><p><b>«Данные»</b> → <b>«UN Comtrade»</b> или <b>«World Bank WITS»</b>: выберите страны (можно целым регионом, например «Европа»), товар по коду ТН ВЭД и период, затем <b>«Загрузить данные»</b>.</p></div>
                <div class="step"><div class="n">3</div><p><b>«Зарубежная таможня»</b> — готовая статистика по ряду стран (Казахстан, Кыргызстан, Колумбия) на уровне товаров и контрагентов, без загрузки.</p></div>
                <div class="step"><div class="n">4</div><p><b>«Анализ»</b> — автоматические рейтинги стран, динамика по годам, цены и доли рынка по загруженным данным.</p></div>
                <div class="step"><div class="n">5</div><p><b>Выгрузка результата:</b> «Скачать оригинал (Excel)», «Для презентации (Excel)» или <b>«Аналитическая записка (HTML)»</b> — готовый отчёт в фирменном стиле.</p></div>
                <div class="step"><div class="n">6</div><p><b>«Презентация»</b> — сборка слайдов из рассчитанных показателей.</p></div>
            </div>
            <a class="cta" href="/?stand=1">Открыть демо-стенд →</a>
            <div class="note">Стенд открывается в этом же окне. Чтобы вернуться в кабинет — обновите адрес сайта без параметров или войдите заново.</div>
        </div>
