    ...
    <div class="card">
        ...
        <div class="body">
            <div class="lead">
                ...
                экспертизе. Загрузка сторонних данных в этом режиме отключена.
            </div>
            <div class="steps">
                <div class="step"><div class="n">1</div><p>Откройте стенд кнопкой ниже — приложение запустится в режиме экспертизы.</p></div>
                <div class="step"><div class="n">2</div><p>В разделе <b>«Данные»</b> выберите источник (UN Comtrade или WITS), задайте страны, товар (ТН ВЭД) и период — <b>«Загрузить данные»</b>.</p></div>
                <div class="step"><div class="n">3</div><p>Перейдите в <b>«Анализ»</b>: рейтинги стран, динамика, цены. Выгрузку можно скачать в Excel или как <b>аналитическую записку (HTML)</b>.</p></div>
                <div class="step"><div class="n">4</div><p>Техническая документация (установка, функциональные характеристики, процессы ЖЦ, эксплуатация) передана отдельным комплектом.</p></div>
            </div>
