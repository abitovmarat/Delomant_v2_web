...
(function () {
    ...
    /*
     * Виды анализа. Список соответствует тому, что действительно считается
     * по данным UN Comtrade и World Bank WITS: сведений об организациях
     * (получатели, отправители, изготовители) в этой статистике нет,
     * поэтому таких сценариев здесь не заявляем.
     */
    var ANALYSES = [
        ...
        ['Географическая структура торговли', 'Распределение поставок по странам и регионам.'],
        ['Товарная структура торговли', 'Соотношение товарных групп и позиций в общем объёме.'],
        ['Потоки между странами', 'Направления поставок: откуда, куда и в каком объёме.'],
        ['Поквартальная динамика', 'Сезонность и колебания объёмов и цен внутри года.'],
        ['Изменения рынка между периодами', 'Что выросло, что сократилось при сравнении периодов.'],
        ['Сигналы и риски', 'Резкие отклонения цен и объёмов, требующие внимания.'],
        ['Настраиваемые сводные таблицы', 'Свои разрезы по странам, товарам и периодам.'],
        ['Темпы роста и CAGR', 'Динамика год к году и среднегодовой темп роста.'],
        ['Тарифные ставки WITS TRAINS', 'Импортные пошлины и барьеры входа на рынок.']
    ];
