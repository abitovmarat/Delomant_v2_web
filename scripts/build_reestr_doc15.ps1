param(
    ...
    [string]$MarkdownPath = "docs\reestr\15_Техническая_архитектура.md",
    [string]$OutputPath = "документация для проверки\Техническая_архитектура_Delomant_0.9.docx"
)
...
try {
    ...
    Set-ParagraphText $document.Paragraphs.Item(6) 'содержащая описание технической архитектуры программного обеспечения'
    ...
    try {
        $document.BuiltInDocumentProperties.Item('Title').Value = 'Техническая архитектура. Delomant Analytics System 0.9'
        ...
        $document.BuiltInDocumentProperties.Item('Keywords').Value = 'Delomant, техническая архитектура, реестр российского ПО'
    } catch {}
